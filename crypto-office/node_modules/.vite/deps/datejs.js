...
var require_i18n = __commonJS({
  "node_modules/datejs/src/core/i18n.js"(exports) {
    (function() {
      var $D = Date;
      ...
      var getText = {
        getFromKey: function(key, countryCode) {
          ...
          if (Date.CultureStrings && Date.CultureStrings[countryCode] && Date.CultureStrings[countryCode][key]) {
            output2 = Date.CultureStrings[countryCode][key];
          } else {
            output2 = getText.buildFromDefault(key);
          }
          if (key.charAt(0) === "/") {
            output2 = getText.buildFromRegex(key, countryCode);
          }
          return output2;
        },
        getFromObjectValues: function(obj, countryCode) {
          ...
          for (key in obj) {
            if (obj.hasOwnProperty(key)) {
              output2[key] = getText.getFromKey(obj[key], countryCode);
            }
          }
          return output2;
        },
        getFromObjectKeys: function(obj, countryCode) {
          ...
          for (key in obj) {
            if (obj.hasOwnProperty(key)) {
              output2[getText.getFromKey(key, countryCode)] = obj[key];
            }
          }
          return output2;
        },
        getFromArray: function(arr, countryCode) {
          ...
          for (var i = 0; i < arr.length; i++) {
            if (i in arr) {
              output2[i] = getText.getFromKey(arr[i], countryCode);
            }
          }
          return output2;
        },
        buildFromDefault: function(key) {
          var output2, length, split, last;
          switch (key) {
            case "name":
              output2 = "en-US";
              break;
            case "englishName":
              output2 = "English (United States)";
              break;
            case "nativeName":
              output2 = "English (United States)";
              break;
        ...
        buildFromRegex: function(key, countryCode) {
          var output2;
          if (Date.CultureStrings && Date.CultureStrings[countryCode] && Date.CultureStrings[countryCode][key]) {
            output2 = new RegExp(Date.CultureStrings[countryCode][key], "i");
          } else {
            output2 = new RegExp(key.replace(new RegExp("/", "g"), ""), "i");
          }
          return output2;
        }
      };
  ...
  "node_modules/datejs/src/core/core.js"() {
    (function() {
      ...
      $D.initOverloads = function() {
        ...
        if ($P._toString === void 0) {
          $P._toString = $P.toString;
        }
      };
      $D.initOverloads();
      $D.today = function() {
        return (/* @__PURE__ */ new Date()).clearTime();
      };
      $D.present = function() {
      ...
      $D.getTimezoneAbbreviation = function(offset, dst) {
        var p2, n = dst || false ? Date.CultureInfo.abbreviatedTimeZoneDST : Date.CultureInfo.abbreviatedTimeZoneStandard;
        for (p2 in n) {
          if (n.hasOwnProperty(p2)) {
            if (n[p2] === offset) {
              return p2;
            }
          }
      ...
      $D.getTimezoneOffset = function(name, dst) {
        ...
        if (!name) {
          name = (/* @__PURE__ */ new Date()).getTimezone();
        }
      ...
      $D.getDaysLeftInQuarter = function(d) {
        ...
        return Math.floor((qEnd - d) / 864e5);
      };
      ...
      $D.validateDay = function(value, year, month) {
        if (year === void 0 || year === null || month === void 0 || month === null) {
          return false;
        }
...
var require_core_prototypes = __commonJS({
  "node_modules/datejs/src/core/core-prototypes.js"() {
    (function() {
      var $D = Date, $P = $D.prototype, p = function(s, l) {
        if (!l) {
      ...
      var validateConfigObject = function(obj) {
        ...
        testFunc = function(prop2, func2, value) {
          if (prop2 === "day") {
            var month = obj.month !== void 0 ? obj.month : self.getMonth();
            var year = obj.year !== void 0 ? obj.year : self.getFullYear();
            return $D[func2](value, year, month);
          } else {
            return $D[func2](value);
          }
        };
        for (prop in obj) {
      ...
      $P.equals = function(date) {
        return Date.equals(this, date !== void 0 ? date : /* @__PURE__ */ new Date());
      };
      $P.between = function(start, end) {
        return this.getTime() >= start.getTime() && this.getTime() <= end.getTime();
      };
      $P.isAfter = function(date) {
        return this.compareTo(date || /* @__PURE__ */ new Date()) === 1;
      };
      $P.isBefore = function(date) {
        return this.compareTo(date || /* @__PURE__ */ new Date()) === -1;
      };
      $P.isToday = $P.isSameDay = function(date) {
        return this.clone().clearTime().equals((date || /* @__PURE__ */ new Date()).clone().clearTime());
      };
      ...
      $P.getUTCOffset = function(offset) {
        var n = (offset || this.getTimezoneOffset()) * -10 / 6, r2;
        if (n < 0) {
          r2 = (n - 1e4).toString();
          return r2.charAt(0) + r2.substr(2);
        } else {
          r2 = (n + 1e4).toString();
          return "+" + r2.substr(1);
        }
      ...
      $P.getElapsed = function(date) {
        return (date || /* @__PURE__ */ new Date()) - this;
      };
...
var require_sugarpak = __commonJS({
  "node_modules/datejs/src/core/sugarpak.js"() {
    (function() {
      ...
      $N.fromNow = $N.after = function(date) {
        ...
        return (!date ? /* @__PURE__ */ new Date() : date.clone()).add(c);
      };
      ...
      $P.toObject = function() {
        var o = {};
        for (var i = 0; i < px2.length; i++) {
          if (this["get" + pxf[i]]) {
            o[px2[i].toLowerCase()] = this["get" + pxf[i]]();
          }
        }
        return o;
      };
      ...
      var sdf = function(n) {
        return function() {
          var t2 = $D.today(), shift = n - t2.getDay();
          if (n === 0 && Date.CultureInfo.firstDayOfWeek === 1 && t2.getDay() !== 0) {
            shift = shift + 7;
          }
          return t2.addDays(shift);
        };
      };
      ...
      var ef = function(j) {
        return function() {
          ...
          if (this._same) {
            ...
            var o1 = this.toObject(), o2 = (arguments[0] || /* @__PURE__ */ new Date()).toObject(), v = "", k2 = j.toLowerCase();
            k2 = k2[k2.length - 1] === "s" ? k2.substring(0, k2.length - 1) : k2;
            for (var m = px2.length - 1; m > -1; m--) {
              v = px2[m].toLowerCase();
              if (o1[v] !== o2[v]) {
                return false;
              }
      ...
      for (var k = 0; k < px2.length; k++) {
        de = px2[k].toLowerCase();
        if (de !== "weekday") {
          $P[de] = $P[de + "s"] = ef(px2[k]);
          $N[de] = $N[de + "s"] = nf(de + "s");
        }
      }
      $P._ss = ef("Second");
...
var require_format_parser = __commonJS({
  "node_modules/datejs/src/core/format_parser.js"() {
    (function() {
      "use strict";
      Date.Parsing = {
      ...
      var utils = {
        ...
        buildTimeObjectFromData: function(data) {
          var time = utils.timeDataProcess({
            ...
            mods: {
              month: function(data2) {
                return data2 - 1;
              },
              weekDay: function(data2) {
                data2 = Math.abs(data2);
                return data2 === 7 ? 0 : data2;
              },
              minutes: function(data2) {
                return data2.replace(":", "");
              },
              seconds: function(data2) {
                return Math.floor(data2.replace(":", "").replace(",", ".") * 1);
              },
              milliseconds: function(data2) {
                return data2.replace(",", ".") * 1e3;
              }
            },
            postProcess: {
              minutes: true,
      ...
      $P.Normalizer = {
        ...
        keys: function() {
          return [
            utils.getDateNthString(true, false, 1),
            // tomorrow
            utils.getDateNthString(true, false, -1),
            // yesterday
            utils.getDateNthString(false, true, "monday"),
            //last mon
            utils.getDateNthString(false, true, "tuesday"),
            //last tues
            utils.getDateNthString(false, true, "wednesday"),
            //last wed
            utils.getDateNthString(false, true, "thursday"),
            //last thurs
            utils.getDateNthString(false, true, "friday"),
            //last fri
            utils.getDateNthString(false, true, "saturday"),
            //last sat
            utils.getDateNthString(false, true, "sunday")
            //last sun
          ];
        },
        buildRegexFunctions: function() {
          ...
          this.replaceFuncs = [
            ...
            [
              tomorrowRE,
              function(full, m1) {
                var t2 = Date.today().addDays(1).toString("d");
                return t2 + " " + m1;
              }
            ],
...
var require_parsing_operators = __commonJS({
  "node_modules/datejs/src/core/parsing_operators.js"() {
    (function() {
      var $P = Date.Parsing;
      var _ = $P.Operators = {
        ...
        product: function() {
          var px2 = arguments[0], qx = Array.prototype.slice.call(arguments, 1), rx = [];
          for (var i2 = 0; i2 < px2.length; i2++) {
            rx.push(_.each(px2[i2], qx));
          }
          return rx;
        },
        cache: function(rule) {
          var cache = {}, cache_length = 0, cache_keys = [], CACHE_MAX = Date.Config.CACHE_MAX || 1e5, r2 = null;
          ...
          return function(s) {
            cacheCheck();
            try {
              r2 = cache[s] = cache[s] || rule.call(this, s);
            } catch (e) {
              r2 = cache[s] = e;
            }
            cache_length++;
            cache_keys.push(s);
            if (r2 instanceof $P.Exception) {
              throw r2;
            } else {
              return r2;
            }
        ...
        all: function() {
          var px2 = arguments, _2 = _2;
          return _2.each(_2.optional(px2));
        },
        // delimited operators
        sequence: function(px2, d, c) {
          d = d || _.rtoken(/^\s*/);
          c = c || null;
          if (px2.length === 1) {
            return px2[0];
        ...
        set: function(px2, d, c) {
          d = d || _.rtoken(/^\s*/);
          c = c || null;
          return function(s) {
            var r2 = null, p = null, q = null, rx = null, best = [[], s], last = false;
            for (var i2 = 0; i2 < px2.length; i2++) {
              q = null;
              p = null;
              r2 = null;
...
var require_parsing_translator = __commonJS({
  "node_modules/datejs/src/core/parsing_translator.js"() {
    (function() {
      var $D = Date;
      ...
      var finishUtils = {
        ...
        generateDateFromWeeks: function() {
          var weekday = this.weekday !== void 0 ? this.weekday : "today";
...
var require_parsing_grammar = __commonJS({
  "node_modules/datejs/src/core/parsing_grammar.js"() {
    (function() {
      var $D = Date;
      $D.Grammar = {};
      var _ = $D.Parsing.Operators, g = $D.Grammar, t2 = $D.Translator, _fn;
      _fn = function() {
      ...
      g.ctoken = function(keys) {
        ...
        if (!fn) {
          ...
          var kx = keys.split(/\s+/), px2 = [];
          for (var i = 0; i < kx.length; i++) {
            px2.push(_.replace(_.rtoken(c[kx[i]]), kx[i]));
          }
          fn = _C[keys] = _.any.apply(null, px2);
        }
        return fn;
      };
      ...
      var grammarFormats = {
        timeFormats: function() {
          ...
          g.t = cacheProcessCtoken("shortMeridian", t2.meridian);
          g.tt = cacheProcessCtoken("longMeridian", t2.meridian);
          g.zzz = cacheProcessCtoken("timezone", t2.timezone);
        ...
        dateFormats: function() {
          ...
          g.MMM = g.MMMM = _.cache(_.process(g.ctoken("jan feb mar apr may jun jul aug sep oct nov dec"), t2.month));
          g.ddd = g.dddd = _.cache(_.process(
            g.ctoken("sun mon tue wed thu fri sat"),
            function(s) {
              return function() {
                this.weekday = s;
              };
        ...
        relative: function() {
          g.orientation = _.process(
            g.ctoken("past future"),
            function(s) {
              return function() {
                this.orient = s;
              };
          ...
          g.operator = _.process(
            g.ctoken("add subtract"),
            function(s) {
              return function() {
                this.operator = s;
              };
          ...
          g.rday = _.process(g.ctoken("yesterday tomorrow today now"), t2.rday);
          g.unit = _.process(
      ...
      g.buildGrammarFormats = function() {
        ...
        g.format = _.process(
          ...
          function(rules) {
            return _.process(_.each.apply(null, rules), t2.finishExact);
          }
        );
    ...
    (function() {
      ...
      var parseUtils = {
        ...
        grammarParser: function(s) {
          var r2 = null;
          try {
            r2 = $D.Grammar.start.call({}, s.replace(/^\s*(\S*(\s+\S+)*)\s*$/, "$1"));
          } catch (e) {
            return null;
          }
          return r2[1].length === 0 ? r2[0] : null;
        },
        nativeFallback: function(s) {
          var t2;
          try {
            t2 = Date._parse(s);
            return t2 || t2 === 0 ? new Date(t2) : null;
          } catch (e) {
            return null;
          }
        }
  ...
  "node_modules/datejs/src/core/extras.js"() {
    (function() {
      ...
      var normalizer = {
        ...
        interpreted: function(m, x) {
          ...
          switch (m) {
            ...
            case "%U":
              var d1 = x.clone().set({ month: 0, day: 1 }).addDays(-1).moveToDayOfWeek(0), d2 = x.clone().addDays(1).moveToDayOfWeek(0, -1);
        ...
        parse: function(m, context) {
          var formatString, c = context || /* @__PURE__ */ new Date();
      ...
      $D.normalizeFormat = function(format, context) {
        return format.replace(/(%|\\)?.|%%/g, function(t2) {
          return normalizer.parse(t2, context);
        });
      };
...
var require_time_period = __commonJS({
  "node_modules/datejs/src/core/time_period.js"() {
    (function() {
      "use strict";
      ...
      var addSetFuncs = function(context, attrs2) {
        for (var i = 0; i < attrs2.length; i++) {
          var $a = attrs2[i], $b = $a.slice(0, 1).toUpperCase() + $a.slice(1);
...
var require_time_span = __commonJS({
  "node_modules/datejs/src/core/time_span.js"() {
    (function() {
      "use strict";
      var gFn = function(attr) {
      ...
      var TimeSpan2 = function(days, hours, minutes, seconds, milliseconds) {
        if (arguments.length === 1 && typeof days === "number") {
          var orient = days < 0 ? -1 : 1;
          var millsLeft = Math.abs(days);
          this.setDays(Math.floor(millsLeft / 864e5) * orient);
          millsLeft = millsLeft % 864e5;
          this.setHours(Math.floor(millsLeft / 36e5) * orient);
          millsLeft = millsLeft % 36e5;
          this.setMinutes(Math.floor(millsLeft / 6e4) * orient);
          millsLeft = millsLeft % 6e4;
          this.setSeconds(Math.floor(millsLeft / 1e3) * orient);
          millsLeft = millsLeft % 1e3;
        ...
        this.add = function(time) {
          return time === null ? this : this.addSeconds(time.getTotalMilliseconds() / 1e3);
        };
        this.subtract = function(time) {
          return time === null ? this : this.addSeconds(-time.getTotalMilliseconds() / 1e3);
        };
        this.addDays = function(n) {
          return new TimeSpan2(this.getTotalMilliseconds() + n * 864e5);
        };
        this.addHours = function(n) {
          return new TimeSpan2(this.getTotalMilliseconds() + n * 36e5);
        };
        this.addMinutes = function(n) {
          return new TimeSpan2(this.getTotalMilliseconds() + n * 6e4);
        };
        this.addSeconds = function(n) {
          return new TimeSpan2(this.getTotalMilliseconds() + n * 1e3);
        };
        this.addMilliseconds = function(n) {
          return new TimeSpan2(this.getTotalMilliseconds() + n);
        };
      ...
      addSetFuncs(TimeSpan2, attrs.slice(2));
      TimeSpan2.prototype.set = function(days, hours, minutes, seconds, milliseconds) {
        this.setDays(days || this.getDays());
        this.setHours(hours || this.getHours());
        this.setMinutes(minutes || this.getMinutes());
        this.setSeconds(seconds || this.getSeconds());
      ...
      Date.prototype.getTimeOfDay = function() {
        return new TimeSpan2(0, this.getHours(), this.getMinutes(), this.getSeconds(), this.getMilliseconds());
      };
      Date.TimeSpan = TimeSpan2;
      if (typeof window !== "undefined") {
        window.TimeSpan = TimeSpan2;
      }
    })();
  }
});
...
require_i18n();
require_core();
require_core_prototypes();
require_sugarpak();
require_format_parser();
require_parsing_operators();
require_parsing_translator();
require_parsing_grammar();
require_parser();
require_extras();
require_time_period();
require_time_span();
